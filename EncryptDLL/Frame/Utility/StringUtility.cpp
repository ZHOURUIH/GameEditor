...
string StringUtility::mIntString[INT_STRING_COUNT];
const ullong StringUtility::POWER_INT_10[POWER_INT_COUNT]{ 1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000, 10000000000 };
const ullong StringUtility::POWER_ULLONG_10[POWER_ULLONG_COUNT]
{
	1ul,
	10ul,
	100ul,
