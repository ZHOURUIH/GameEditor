...
void StringUtility::split(std::string str, const char* deli, txVector<std::string>& vec)
{
	while (true)
	{
...
int StringUtility::strFind(const std::string& res, const std::string& sub, const int& startPose, const bool& fromStart)
{
