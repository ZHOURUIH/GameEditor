...
void StringUtility::split(std::string str, const char* deli, std::vector<std::string>& vec, bool removeEmpty)
{
	while (true)
	{
...
std::vector<std::string> StringUtility::findSubstr(std::vector<std::string>& res, std::string dst, bool sensitive)
{
