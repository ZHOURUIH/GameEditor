...
public:
	...
	static float getFloatParam(const GAME_DEFINE_FLOAT& param)
	{
	...
	static std::string getStringParam(const GAME_DEFINE_STRING& param)
	{
...
protected:
	void setFloatParam(const GAME_DEFINE_FLOAT& param, const float& value);
	void setStringParam(const GAME_DEFINE_STRING& param, const std::string& value);
public:
