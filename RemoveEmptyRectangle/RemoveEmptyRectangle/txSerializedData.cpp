...
//	{
//		*(int*)(dataParam.mDataPtr) = Utility::stringToInt(dataString);
//	}
//	else if (paramType == typeid(short).name())
//	{
//		*(short*)(dataParam.mDataPtr) = Utility::stringToInt(dataString);
//	}
//	else if (paramType == typeid(float).name())
//	{
//		*(float*)(dataParam.mDataPtr) = Utility::stringToFloat(dataString);
//	}
...
//}
//
//bool txSerializedData::readStringList(std::vector<std::string>& dataList)
//{
//	int curIndex = 0;
//	int parameterCount = mDataParameterList.size();
//	for (int i = 0; i < parameterCount; ++i)
