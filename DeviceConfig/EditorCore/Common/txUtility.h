...
public:
	...
	static bool copyFile(const std::string& sourceFile, const std::string& destFile, const bool& overWrite = true);
	...
	static std::vector<std::string> findSubstr(std::vector<std::string>& res, std::string dst, const bool& sensitive)
	{
		std::vector <std::string> retList;
	...
	static void jsonStartStruct(std::string& str, const int& preTableCount = 0, const bool& returnLine = false)
	{
		for (int i = 0; i < preTableCount; ++i)
		{
			str += "\t";
	...
	static void jsonAddPair(std::string& str, std::string name, std::string value, const int& preTableCount = 0, const bool& returnLine = false)
	{
		for (int i = 0; i < preTableCount; ++i)
		{
			str += "\t";
