...
//	{
//		// 根据当前外观和武器,设置资源图集
//		string clothResource = CommonDefine.R_ATLAS_TEXTURE_ANIM_PATH + "Human/" + GameUtility.getEquipResource(mData.mClothID);
//		string weaponResource = CommonDefine.R_ATLAS_TEXTURE_ANIM_PATH + "Weapon/" + GameUtility.getEquipResource(mData.mWeaponID);
...
//		{
//			// 根据当前角色数据从数据库查询本地数据
//			List<EquipFrameData> weaponDataList;
//			mSQLiteEquipFrame.query(mData.mWeaponID, i, name, out weaponDataList);
//			if (weaponDataList.Count != 1)
//			{
//				logError("weapon info error!");
//				return;
//			}
//			List<EquipFrameData> clothDataList;
//			mSQLiteEquipFrame.query(mData.mClothID, i, name, out clothDataList);
