...
std::string FileUtility::generateFileMD5(const std::string& fileName)
{
	int bufferSize = 1024 * 8;
	char* buffer = TRACE_NEW_ARRAY(char, bufferSize, buffer);
	std::string md5 = generateFileMD5(fileName, buffer, bufferSize);
