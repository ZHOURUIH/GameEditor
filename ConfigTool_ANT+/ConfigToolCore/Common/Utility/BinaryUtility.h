...
public:
	...
	static unsigned short CRC_Calc16(const volatile void *pvDataPtr_, unsigned int ulSize_);
	static unsigned short CRC_UpdateCRC16(unsigned short usCRC_, const volatile void *pvDataPtr_, unsigned int ulSize_);
	static unsigned short CRC_Get16(unsigned short usCRC_, unsigned char ucByte_);
};
