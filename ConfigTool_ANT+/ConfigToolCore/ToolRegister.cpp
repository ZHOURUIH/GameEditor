...
ToolRegister::~ToolRegister()
{
 ...
 std::string ToolRegister::readRegistryValue(const std::string& companyName, const std::string& gameName, const std::string& keyName)
 {
	 //打开注册表  
	 HKEY hKey;
 ...
 bool ToolRegister::writeRegistryValue(const std::string& companyName, const std::string& gameName, const std::string& value, const std::string& keyName)
 {
	 //打开注册表  
	 HKEY hKey;
