...
void SpeedDataPanel::setup()
{
	...
	wxStaticText* m_staticText1 = new wxStaticText(this, wxID_ANY, wxT("设备列表"));
	...
	mListenButton = new wxButton(this, ID_LIETEN_BUTTON, wxT("打开串口"));
	bSizer2->Add(mListenButton, 0, wxALL, 5);
	mCancelListenButton = new wxButton(this, ID_CANCEL_LISTEN_BUTTON, wxT("关闭串口"));
