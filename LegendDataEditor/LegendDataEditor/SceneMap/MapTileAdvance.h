#ifndef _MAP_TILE_ADVANCE_H_
#define _MAP_TILE_ADVANCE_H_
...
public:
	...
	// 对象图集索引
	unsigned char mObjAtlasIndex;
	// 大地砖图集索引
	unsigned char mBngAtlasIndex;
	// 亮度
...
public:
	...
	void initFromOldTile(MapTile& tile, unsigned char objAtlasIndex, unsigned char bngAtlasIndex);
