...
public:
	...
	template<size_t Length>
	static void removeULLongsString(array<char, Length>& valueArrayString, const ullong& value)
	{
	...
	template<size_t Length>
	static void addULLongsString(array<char, Length>& valueArrayString, const ullong& value)
	{
	...
	static void _itoa_s(int value, array<char, Length>& charArray)
	{
		...
		static const array<ullong, 11> power{ 1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000, 10000000000 };
	...
	static void _i64toa_s(const ullong& value, array<char, Length>& charArray)
	{
		...
		static const array<ullong, 20> power =
		{
			1ul,
			10ul,
			100ul,
	...
	static void stringToULLongs(const string& str, myVector<ullong>& valueList, const char* seperate = ",");
	...
	static void appendValueULLong(char* queryStr, uint size, const ullong& value, bool addComma = true);
	template<size_t Length>
	static void appendValueULLong(array<char, Length>& queryStr, const ullong& value, bool addComma = true)
	{
	...
	static void appendConditionULLong(char* condition, uint size, const char* col, const ullong& value, const char* relationalOperator = "=", const char* logicalOperator = NULL);
	template<size_t Length>
	static void appendConditionULLong(array<char, Length>& condition, const char* col, const ullong& value, const char* relationalOperator = "=", const char* logicalOperator = NULL)
	{
		ULLONG_STR(temp, value);
		STR_APPEND4(condition, col, relationalOperator, temp, logicalOperator);
	}
